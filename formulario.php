...
?>
 ...
 <!-- Campo: Estado-->
 <div class="form-group">
   <label class="col-md-4 control-label" for="nome">Estados</label>  
   <div class="col-md-4">
...
<select name="estado">
          ...
          <?php
            ...
            $resultado_estados = $conexaobd->query($estados);
            while($linha_estados = mysqli_fetch_assoc($resultado_estados)){ ?>
              <option value="<?php echo $linha_estados['NOME']; ?>"><?php echo $linha_estados['NOME']; ?></option>
...
<select name="combomunicipio">
  <option> Selecione uma Cidade</option>
          ...
          <?php
            ...
            require_once 'conexao_BD.php';
            $municipios = "SELECT * FROM municipios ORDER BY NOME ASC";
...
<select name="filhos" type="text" required>
 ...
 <div class="col-md-4">
   <input id="telefone" name="telefone" placeholder="Informe o telefone (00)00000-0000" class="form-control input-md"pattern="\([0-9]{2}\)[0-9]{5}-[0-9]{4}" required="" type="text" required>
    <span class="help-block">Formato do telefone (XX)XXXXX-XXXX</span>
 </div>
 <br>
...
<div class="col-md-4">
<select name="categoriacnh" type="text">
<option value=""></option>
...
<option value="AE">AE</option>
 ...
 <div class="col-md-4">
  ...
  <!-- Campo: Área formacao-->
  <div class="form-group">
   <label class="col-md-4 control-label" for="nome">Área de Formação</label>  
   <div class="col-md-4">

  <select name="areaformacao">
  <option>Selecione a Área da Formação</option>
         
          <?php
           
            require_once 'conexao_BD.php';
            $formacao = "SELECT * FROM listaformacao ORDER BY Formacao ASC";
            $resultado_formacao = $conexaobd->query($formacao);
            while($linha_formacao = mysqli_fetch_assoc($resultado_formacao)){ ?>
              <option value="<?php echo $linha_formacao['Formacao']; ?>"><?php echo $linha_formacao['Formacao']; ?></option>
...
<!-- Campo: Outra Formação -->
 <div class="form-group">
   <label class="col-md-4 control-label" for="nome">Outra Formação</label>  
 <div class="col-md-4">
  <input id="nome" name="outraformacao" placeholder="Digite a Formação não encontrada na lista" class="form-control input-md" required="" type="text">
 </div>
 </div>
